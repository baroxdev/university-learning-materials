    ...
    <body>
                    ...
                    <div class="col-form-label" style="margin-bottom: 100px;">
                                                ...
                                                <div id="basic-information-form">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label for="timeAllocation" class="col-form-label"
                                                                       style="font-size: 16px;">
                                                                    Time allocation
                                                                </label>
                                                                <input type="text" id="timeAllocation" name="timeAllocation"
                                                                       class="form-control" required/>
                                                            </div>
                                                            <div class="form-group mb-3">
                                                                <label for="decisionNo" class="col-form-label"
                                                                       style="font-size: 16px;">
                                                                    Decision No
                                                                </label>
                                                                <input type="text" id="decisionNo" name="decisionNo"
                                                                       class="form-control" required/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                <label for="credit" class="col-form-label"
                                                                       style="font-size: 16px;">
                                                                    Number of Credit
                                                                </label>
                                                                <input type="number" value="1" min="1" max="15" step="1"
                                                                       id="credit" name="credit" class="form-control" required/>
                                                            </div>
                                                            <div class="form-group mb-3">
                                                                <label for="minScore" class="col-form-label"
                                                                       style="font-size: 16px;">
                                                                    Min score
                                                                </label>
                                                                <input type="number" value="0" min="0" max="10" step="0.25"
                                                                       id="minScore" name="minScore" class="form-control"/>
                                                            </div>
                                                            <div class="form-group mb-3">
                                                                <label for="maxScore" class="col-form-label"
                                                                       style="font-size: 16px;">
                                                                    Max score
                                                                </label>
                                                                <input type="number" min="0" max="10" step="0.25" id="maxScore"
                                                                       name="maxScore" class="form-control" required/>
                                                            </div>
                                                            <div class="form-group mb-3">
                                                                <label for="preRequisite" class="col-form-label"
                                                                       style="font-size: 16px;">
                                                                    Pre-Requisite
                                                                </label>
                                                                <select style="color: #495057;" name="preRequisite"
                                                                        id="preRequisite" class="form-select">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="form-add row g-3 align-items-center mt-1">
                                                    ...
                                                    <div class="row col-4">
                                                        <div class="col-12">
                                                            <label for="PLOList" class="col-form-label"
                                                                   style="font-size: 16px;">List
                                                                of CLO</label>
                                                        </div>
                                                        <div class="col-12">
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                            ...
                            <div class="offcanvas-body edit-clo-form" id="edit-clo-form">
                                ...
                                <div class="alert alert-danger" id="clo-update-error" role="alert"
                                     style="margin-top: 20px; margin-right: 4px; display: none;">
                                    CLO_ERROR_MESSAGE
                                </div>
                                <div class="mt-4">
                                    <button type="button" id="btn-update-clo" class="btn btn-primary">Save</button>
                                    <button type="button" id="btn-cancel-update" class="btn btn-outline-secondary"
                                            data-bs-dismiss="offcanvas" aria-label="Cancel">Cancel
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            async function handleSubmitAddSyllabus(e) {
                ...
                const submitCLOs = listCLO.map((c) => {
                    c.plo = c.plo.value;
                    return c
                })
            ...
            function renderList(list, type) {
                ...
                if (!executeFn)
                    throw new Error('Invalid type of list. We\'ve supported sessions, questions and assessments. Try again');
