...
import actions.explore.GetExplore;
...
public class ExploreController extends HttpServlet {
    ...
    public void init() {
        actionMap.put("/explore", new GetExplore());
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExploreController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ExploreController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
